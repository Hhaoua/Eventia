    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4">
        ...
        <form method="POST" action="{{ route('register') }}" class="p-6 space-y-4">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label class="flex items-center space-x-2 p-3 border rounded-lg cursor-pointer 
                        {{ old('role', 'participant') === 'participant' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-300' }}">
                    ...
                    <label class="flex items-center space-x-2 p-3 border rounded-lg cursor-pointer
                        {{ old('role') === 'organisateur' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-300' }}">
            ...
            <div class="text-center pt-4">
                <a href="{{ route('login.form') }}" class="text-blue-600 hover:text-blue-700 text-sm">
