...
<div class="max-w-4xl mx-auto py-10">
    ...
    <form action="{{ route('events.update', ['evenement' => $evenement->id]) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-xl shadow-lg space-y-6">
        ...
        <div>
            ...
            <div class="flex space-x-4">
                <label class="flex items-center space-x-2">
                    <input type="radio" name="type" value="free" {{ old('type', $evenement->type) === 'free' ? 'checked' : '' }} required>
                    <span>Gratuit</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="radio" name="type" value="paid" {{ old('type', $evenement->type) === 'paid' ? 'checked' : '' }} required>
                    <span>Payant</span>
                </label>
            </div>
        ...
        {{-- Prix si payant --}}
        <div id="priceField" class="{{ old('type', $evenement->type) === 'paid' ? '' : 'hidden' }}">
        ...
        <div class="flex justify-end">
            <button type="submit"
                class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">Mettre à jour l'événement</button>
        </div>
    </form>
</div>
